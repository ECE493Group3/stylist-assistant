...
describe("Stylist Accepts User", function () {
    ...
    beforeAll(function () {
        user_email = "test_stylist@domain.ca";
        user_pword = "capstone";
        ...
        browser.wait(() => {
            return get_firebase_data().then((data) => {
                ...
                stylist_json = {
                    "68c6DdVoL7SP6EwWg9q4xGUVfpK2": {
                        "email": "test_stylist@domain.ca",
                        "name": "test_stylist",
                        "clientRequests": {
                            "fMhmSWiIoi8PQrlCpj7rGMsKr5Lr1": {
                                "email": "asfd@fads.com",
