...
.config(function($stateProvider, $urlRouterProvider){
	...
	.state('user_upload_images', {
		url: "/user_upload_images/:type/:id",
		templateUrl: "user_upload_images.html",
		controller: "user_images_controller"
	})
	.state('stylist_upload_images', {
		url: "/stylist_upload_images/:type/:id",
		templateUrl: "stylist_upload_images.html",
		controller: "stylist_images_controller"
	})
	.state('user_signin', {
		cache:false,
		url:"/user_signin",
...
.controller("user_images_controller", ["$scope", '$firebaseObject', "$stateParams", "Camera", "$ionicPopover", "$http", "$rootScope", function($scope, $firebaseObject, $stateParams, Camera, $ionicPopover, $http, $rootScope){
...
.controller("stylist_images_controller", ["$scope", '$firebaseObject', "$stateParams", "Camera", "$ionicPopover", "$http", "$rootScope", function($scope, $firebaseObject, $stateParams, Camera, $ionicPopover, $http, $rootScope){
	...
	$scope.text = {
		"beginning": "Style for",
		"end": $firebaseObject(userref.child("name")), 
		"image": "http://picture-cdn.wheretoget.it/45fugz-l-610x610-jacket-bomber+jacket-winter+jacket-spring+jacket-outfit-outfit+idea-summer+outfits-fall+outfits-winter+outfits-cute+outfits-date+outfit-spring+outfits-party+outfits-coat-winter+coa.jpg",
		"description": "Our dataset is designed to recognize items from images with the entire garment shown. Images with more of the garment showing will perform better in the Magic.Try not to crop out large chucks of the item in pictures you upload."
	}
	
	$scope.showType = function(){
		var status = this.typeValue
		...
		if(status == "COMBINATIONS"){
			...
			$scope.isCombination = false;
			$scope.isFullbody = true;	
		}
	}

	$scope.uploadOutfit = function(){
		var status = this.typeValue;
		if(status == "COMBINATIONS"){
			var top = this.top_cat;
			var bottom = this.bottom_cat;
			// $scope.postConent = "data:image/jpg;base64,";
			value = {
				"categorybottom":bottom,
				"categoryfull":"None",
				"categorytop":top,
				"img":$scope.postConent,
			};
			userref.child("recommendeditems").push(value);

		}
		else if(status == "FULLBODY"){
			var fullbody_cat = this.fullbody_cat;
			value = {
				"categorybottom":"None",
				"categoryfull":fullbody_cat,
				"categorytop":"None",
				"img":$scope.postConent,
			}
			userref.child("recommendeditems").push(value);
	...
	$scope.takePhoto = function () {
		...
		Camera.getPicture(options).then(function (imageData) {
			// add photo to db and come back and update clothingPieces
			$scope.imgURI = imageData;
			$scope.postConent = "data:image/jpg;base64,"+imageData;
		},
		function (err) {
			console.log(err);
		});
